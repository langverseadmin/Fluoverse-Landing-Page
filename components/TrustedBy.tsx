  ...
  return (
    <section className="py-16 lg:py-20 overflow-hidden">
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        <h3 className="text-center text-white/70 font-semibold text-lg mb-8 lg:mb-12">
          Trusted by
        </h3>
        <div className="relative py-6">
          {/* Left gradient hint - must be above scrolling content */}
          <div className="absolute left-0 w-24 bg-gradient-to-r from-[#1a0b2e] via-[#1a0b2e] to-transparent z-20 pointer-events-none" style={{ top: '0px', bottom: '0px', height: '100%' }}></div>
          {/* Right gradient hint - must be above scrolling content */}
          <div className="absolute right-0 w-24 bg-gradient-to-l from-[#1a0b2e] via-[#1a0b2e] to-transparent z-20 pointer-events-none" style={{ top: '0px', bottom: '0px', height: '100%' }}></div>
          {/* Top border */}
            ...
            <div className="flex items-center gap-8 lg:gap-12 animate-scroll" style={{ width: 'fit-content' }}>
              {duplicatedPartners.map((partner, index) => (
                <div
                  ...
                  title={partner.name}
                >
                  <div className="relative w-[200px] h-[120px] bg-white rounded-lg flex items-center justify-center p-4 shadow-sm">
                    <Image
                      src={partner.logo}
                      alt={partner.name}
                      width={200}
                      height={120}
                      className="object-contain max-h-[100px] max-w-[180px] w-auto h-auto"
                      onError={(e) => {
